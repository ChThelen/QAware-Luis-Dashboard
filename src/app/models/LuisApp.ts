...
export const DUMMY_APPS: LuisApp[] = [
  {
    ...
    appJson: JSON.parse(exampleLuisJson)
  },
  {
    appID: "e646d8fd-201a-4688-b86a-f90ba098d91f",
    name: "App 2",
